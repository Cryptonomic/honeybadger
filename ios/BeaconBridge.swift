...
class BeaconBridge: NSObject {
  ...
  @Published var id: String = BeaconBridge.examplePeerID
  @Published var name: String = BeaconBridge.examplePeerName
  @Published var publicKey: String = BeaconBridge.examplePeerPublicKey
  @Published var relayServer: String = BeaconBridge.examplePeerRelayServer
  @Published var version: String = BeaconBridge.examplePeerVersion
